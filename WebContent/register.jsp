...
<head>
    ...
    <title>Bootstrap Form with Real-Time Validation</title>
    ...
    <div class="card-body">
        ...
        <form action="RegisterServlet" method="post" id="registrationForm">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="phone" name="phone" placeholder="Enter your valid mobile number" required>
            ...
            <div class="text-center">
                ...
                <div>Already have an account? <a href="login.jsp">Login in</a></div>
            </div>
        </form>
    </div>
</div>
